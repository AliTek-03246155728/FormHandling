    ...
    <div>
     ...
     <p style={{fontSize:"3vw"}}> Enter your Password here:</p>
      ...
      <p  onClick={() => navigate("/auth")} style={{color:"blue",fontSize:"3vw", display:"inline"}}> Sign Up </p>
       ...
       <button style={{ alignItems:"center",borderRadius:"20vh", backgroundColor:"blue", color:"white" , fontSize:"3vw" , height:"3vh", padding: "10px 20px",  border: "none", cursor: "pointer"}} >Login</button>
      </center>
    </div>
  );
}
